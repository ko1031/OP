...
export const SAMPLE_DECKS = [
  ...
  },
  {
    ...
    tier: 2,
    colors: ['緑'],
    description: 'ボニーのコスト操作で高コストキャラを軽く展開するテンポデッキ。ミホーク・ドフラミンゴなど強力なキャラを序盤から叩きつける。1月環境で複数のフラッグシップを制した。',
    deck: [
      { cardNumber: 'ST02-007',  count: 4 },
      { cardNumber: 'EB01-015',  count: 4 },
      { cardNumber: 'ST24-002',  count: 3 },
      { cardNumber: 'OP10-032',  count: 4 },
      { cardNumber: 'OP12-118',  count: 4 },
      { cardNumber: 'EB01-012',  count: 4 },
      { cardNumber: 'OP14-033',  count: 4 },
      { cardNumber: 'OP08-023',  count: 4 },
      { cardNumber: 'ST24-005',  count: 3 },
      { cardNumber: 'OP06-035',  count: 2 },
      { cardNumber: 'OP13-031',  count: 3 },
      { cardNumber: 'ST16-004',  count: 3 },
      { cardNumber: 'OP12-030',  count: 4 },
      { cardNumber: 'OP04-031',  count: 4 },
    ],
  },
  {
    id: 'flagship_2025_green_mihawk',
    name: '緑ミホーク',
    leaderCard: 'OP14-020',
    date: '2025/11/30',
    event: 'フラッグシップバトル優勝',
    ...
    tier: 2,
    colors: ['緑'],
    description: 'OP14新規リーダー。剣士・王下七武海のシナジーを活かした中速コントロール。ボニーのコスト操作でミホーク本体も早出しでき、強力な除去イベントで盤面を制圧する。',
    deck: [
      { cardNumber: 'OP14-119',  count: 3 },
      { cardNumber: 'ST02-007',  count: 4 },
      { cardNumber: 'OP12-034',  count: 4 },
      { cardNumber: 'EB01-015',  count: 4 },
      { cardNumber: 'PRB02-006', count: 4 },
      { cardNumber: 'OP14-033',  count: 2 },
      { cardNumber: 'OP14-029',  count: 4 },
      { cardNumber: 'OP12-118',  count: 2 },
      { cardNumber: 'OP07-026',  count: 2 },
      { cardNumber: 'OP13-031',  count: 3 },
      { cardNumber: 'OP14-027',  count: 4 },
      { cardNumber: 'ST24-004',  count: 3 },
      { cardNumber: 'OP12-037',  count: 3 },
      { cardNumber: 'OP06-038',  count: 3 },
      { cardNumber: 'OP13-040',  count: 2 },
      { cardNumber: 'OP14-039',  count: 3 },
    ],
  },
];
