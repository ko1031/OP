...
export const META_DECKS = [
  ...
  },
  {
    ...
    counterDense: true,
    tier: 1,
    description: 'OP12登場の青紫サンジリーダー。メタシェア12.2%のTier1。ヴィンスモーク兄弟とサンジで展開しつつ、紫のドン加速と青のバウンスを使い分ける。ゴムゴムの巨人など汎用的な紫イベントと組み合わせた安定型ミッドレンジ。2026年2〜3月に複数の大会で優勝実績。',
    strength: '安定した手札補充・青紫の両色カードによる柔軟な展開',
    weakness: 'ライフ4で速攻に対して脆い面がある',
  },
  {
...
export const SAMPLE_DECKS = [
  ...
  },
  {
    ...
    tier: 1,
    colors: ['紫', '黄'],
    description: 'トラファルガー・ロー複数版を軸に紫ドン加速で高コストローを早期展開。シェア18.4%・週次ランキング1位のTier1筆頭。愛してるぜ!!やガンマナイフで防御も万全。',
    deck: [
      { cardNumber: 'OP09-069',  count: 4 },
      { cardNumber: 'OP05-069',  count: 4 },
      { cardNumber: 'ST10-010',  count: 4 },
      { cardNumber: 'OP12-073',  count: 2 },
      { cardNumber: 'OP12-106',  count: 4 },
      { cardNumber: 'OP10-119',  count: 4 },
      { cardNumber: 'P-088',     count: 4 },
      { cardNumber: 'OP10-065',  count: 4 },
      { cardNumber: 'EB04-038',  count: 4 },
      { cardNumber: 'OP12-115',  count: 4 },
      { cardNumber: 'OP12-111',  count: 4 },
      { cardNumber: 'ST18-001',  count: 4 },
      { cardNumber: 'OP10-072',  count: 4 },
