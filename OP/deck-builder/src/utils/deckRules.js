...
// ────────────────────────────────────────────────
// 現在の環境 Tier1〜2 デッキ定義
// 出典: cardrush.media 大会結果（2026年3〜4月）直近14日間分布より自動集計
//       ※ 2026年4月1日規制: 4プリン禁止
// 環境: OP15「神の島の冒険」+ OP14 + EB04
// 直近14日デッキ分布（4/6時点）: 青黄ナミ 優3準1 / 紫エネル 優3 / 緑ミホーク 優1準1
//                               赤青ルーシー 優1 / 青黄ハンコック 優1 / 空島ルフィ 優1
//                               緑黄しらほし 優1 / 黒ティーチ 優1 / 紫ドフラミンゴ 優1
// Tier定義: Tier1=直近2週で複数入賞・デッキパワー高・不利対面が少ない
//           Tier2=直近2週で入賞実績あり or 環境に残る中堅
// ────────────────────────────────────────────────
export const META_DECKS = [
  {
    ...
    description: '五老星のKO耐性で除去を封じるコントロール。ゴロセイループは強力だが、直近2週の大会では入賞ゼロ。紫エネル・緑ミホークに不利。デッキパワーは健在だがTier2に後退。',
  ...
  },
  {
    ...
    description: 'リーダー効果でアタック時に手札1枚を2000カウンターに変換しつつドロー。攻守一体の汎用ミッドレンジ。OP13〜OP14でTier1を維持したが、OP15環境（直近2週）では入賞ゼロ。紫エネル・赤青ルーシーが台頭しポジションが後退してTier2。',
  ...
  },
  {
    ...
    counterDense: true,
    tier: 2,
    description: 'OP12登場のロシナンテ（コラソン）リーダー。OP14環境でメタシェア18.4%・週次ランキング1位を誇ったが、OP15で紫エネルが台頭し相対的にポジション後退。直近2週の大会で入賞ゼロ。ロー軸の安定性は健在でTier2には残る。',
  ...
  },
  {
    ...
    counterDense: false,
    tier: 1,
    description: 'OP14新規リーダー（単色緑）。直近2週で優勝1・準優勝1と安定した入賞実績。剣士・王下七武海のシナジーでボニーのコスト操作+ミホーク本体の早出しが強力。OP15でも対応できる除去性能でTier1に浮上。',
  ...
  },
  {
    ...
    counterDense: true,
    tier: 2,
    description: 'OP15新リーダー。空島（スカイピア）特徴シナジーで手軽に展開できる青黄アグロ。そだ杯4/1優勝。空島特徴を持つキャラを大量採用しリーダー効果でドンを回収しながら高速展開する。青黄ナミとは差別化された速攻型。',
    strength: '空島特徴統一による安定サーチ・ドン回収で手数が増える',
    weakness: '特徴縛りで構築の自由度が低い。紫エネルの高コスト展開に押されやすい',
  },
  {
    id: 'black_teach',
    name: '黒ティーチ',
    ...
    counterDense: false,
    tier: 2,
    description: 'OP9リーダー。七武海・黒ひげ海賊団のシナジーで盤面を制圧する黒コントロール。天竜杯3/30優勝。多彩な除去と高パワーキャラで相手の展開を阻害しながら長期戦に持ち込む。',
    strength: '豊富な除去・高パワーキャラによる盤面制圧',
    weakness: 'ライフ4で速攻に脆い。カウンター密度が低い',
  },
  {
    id: 'greenyellow_shirahoshi',
    name: '緑黄しらほし',
    colors: ['緑', '黄'],
    style: 'midrange',
    avgCost: 3.2,
    ...
    counterDense: true,
    tier: 2,
    description: 'OP11リーダー。魚人島特徴シナジーで緑黄の除去＋手札補充を組み合わせた安定型ミッドレンジ。フラッグシップ4/1優勝。しらほし複数バージョンとメガロのサーチで展開が安定しやすい。',
    strength: '魚人島シナジー・安定したサーチ・緑黄の両色除去',
    weakness: '展開が遅めで速攻型のアグロに対処が難しい場面も',
  },
];
...
// ────────────────────────────────────────────────
// フラッグシップバトル優勝サンプルデッキ
// 出典: cardrush.media 大会入賞デッキ（2026年3〜4月、2月分は削除済み）
// ────────────────────────────────────────────────
export const SAMPLE_DECKS = [
  ...
  },
  {
    ...
    deck: [
      ...
      { cardNumber: 'OP10-065',  count: 4 },
      { cardNumber: 'ST18-001',  count: 3 },
      { cardNumber: 'OP14-063',  count: 3 },
      { cardNumber: 'OP14-072',  count: 3 },
      { cardNumber: 'OP14-074',  count: 4 },
      { cardNumber: 'OP14-068',  count: 4 },
      { cardNumber: 'OP14-071',  count: 4 },
      { cardNumber: 'OP14-061',  count: 3 },
      { cardNumber: 'OP14-069',  count: 4 },
      { cardNumber: 'OP10-071',  count: 4 },
      { cardNumber: 'OP07-076',  count: 4 },
      { cardNumber: 'OP13-076',  count: 2 },
      { cardNumber: 'OP10-078',  count: 4 },
    ],
  },
  // ── 以下、同リーダーの複数型 ──
  {
  ...
  // ── 2026年4月 大会入賞デッキ ──
  {
    ...
    tier: 1,
    colors: ['緑'],
    description: '剣士・王下七武海シナジーの単色緑コントロール。cardrush.media 4/1フラッグシップ優勝。ボニー×4でコスト操作し高コストミホーク本体を早出し、強力な除去イベントで盤面を制圧する。直近2週で優1準1のTier1。',
    deck: [
      { cardNumber: 'OP12-034',   count: 4 },
      { cardNumber: 'EB01-015',   count: 1 },
      { cardNumber: 'ST24-002',   count: 4 },
      { cardNumber: 'PRB02-006',  count: 4 },
      { cardNumber: 'OP10-032',   count: 4 },
      { cardNumber: 'OP08-023',   count: 2 },
      { cardNumber: 'OP12-118',   count: 3 },
      { cardNumber: 'OP10-030',   count: 1 },
      { cardNumber: 'OP07-026',   count: 3 },
      { cardNumber: 'OP14-033',   count: 3 },
      { cardNumber: 'OP13-031',   count: 4 },
      { cardNumber: 'ST24-004',   count: 4 },
      { cardNumber: 'ST02-007',   count: 1 },
      { cardNumber: 'OP13-040',   count: 4 },
      { cardNumber: 'OP12-037',   count: 2 },
      { cardNumber: 'OP06-038',   count: 2 },
      { cardNumber: 'OP08-036',   count: 2 },
      { cardNumber: 'OP14-039',   count: 2 },
    ],
  },
  {
    id: 'nonofficial_2026_skyisland_luffy',
    name: '空島ルフィ',
    leaderCard: 'OP15-098',
    date: '2026/4/1',
    event: 'そだ杯（非公認大会）優勝',
    ...
    tier: 2,
    colors: ['青', '黄'],
    description: 'OP15新リーダー。空島特徴を大量採用したアグロ構成。そだ杯4/1優勝。OP15-119/108/109など空島キャラをフル採用し、リーダー効果でドンを回収しながら高速展開する。青黄ナミと差別化された速攻型。',
    deck: [
      { cardNumber: 'OP15-119',   count: 4 },
      { cardNumber: 'OP15-108',   count: 4 },
      { cardNumber: 'EB04-058',   count: 4 },
      { cardNumber: 'OP15-109',   count: 4 },
      { cardNumber: 'OP15-114',   count: 4 },
      { cardNumber: 'OP15-113',   count: 4 },
      { cardNumber: 'OP05-106',   count: 4 },
      { cardNumber: 'OP06-106',   count: 4 },
      { cardNumber: 'OP11-106',   count: 4 },
      { cardNumber: 'OP05-102',   count: 4 },
      { cardNumber: 'EB02-052',   count: 2 },
      { cardNumber: 'OP15-116',   count: 4 },
      { cardNumber: 'OP07-115',   count: 4 },
    ],
  },
  {
    id: 'flagship_2026_greenyellow_shirahoshi',
    name: '緑黄しらほし',
    leaderCard: 'OP11-022',
    date: '2026/4/1',
    event: 'フラッグシップバトル優勝',
    ...
    tier: 2,
    colors: ['緑', '黄'],
    description: '魚人島特徴シナジーの緑黄ミッドレンジ。フラッグシップ4/1優勝。しらほし複数バージョン＋メガロのサーチで展開が安定。EB04新規カードを活かした構成。',
    deck: [
      { cardNumber: 'EB03-052',   count: 4 },
      { cardNumber: 'OP12-102',   count: 4 },
      { cardNumber: 'OP11-030',   count: 4 },
      { cardNumber: 'EB04-018',   count: 4 },
      { cardNumber: 'OP11-107',   count: 4 },
      { cardNumber: 'OP11-036',   count: 4 },
      { cardNumber: 'EB04-016',   count: 4 },
      { cardNumber: 'EB04-011',   count: 4 },
      { cardNumber: 'OP11-033',   count: 4 },
      { cardNumber: 'EB04-058',   count: 4 },
      { cardNumber: 'ST16-004',   count: 2 },
      { cardNumber: 'OP06-035',   count: 2 },
      { cardNumber: 'OP08-036',   count: 4 },
      { cardNumber: 'OP13-040',   count: 2 },
    ],
  },
  {
    id: 'nonofficial_2026_black_teach',
    name: '黒ティーチ',
    leaderCard: 'OP09-081',
    date: '2026/3/30',
    event: '天竜杯（非公認大会）優勝',
    ...
    tier: 2,
    colors: ['黒'],
    description: '七武海・黒ひげ海賊団シナジーの黒コントロール。天竜杯3/30優勝。OP9キャラを中心に豊富な除去と高パワーキャラで盤面を制圧し長期戦に持ち込む。約4,010円の低コスト構成。',
    deck: [
      { cardNumber: 'OP09-093',   count: 4 },
      { cardNumber: 'ST27-003',   count: 3 },
      { cardNumber: 'OP10-082',   count: 4 },
      { cardNumber: 'OP09-083',   count: 4 },
      { cardNumber: 'OP09-084',   count: 1 },
      { cardNumber: 'OP10-086',   count: 3 },
      { cardNumber: 'OP09-086',   count: 4 },
      { cardNumber: 'OP09-089',   count: 4 },
      { cardNumber: 'OP11-083',   count: 4 },
      { cardNumber: 'OP09-090',   count: 4 },
      { cardNumber: 'OP09-095',   count: 4 },
      { cardNumber: 'OP09-098',   count: 3 },
      { cardNumber: 'OP09-096',   count: 4 },
      { cardNumber: 'OP09-099',   count: 4 },
    ],
  },
  {
    id: 'nonofficial_2026_purple_enel_v4',
    name: '紫エネル（フラッグシップ型・4/1）',
    leaderCard: 'OP15-058',
    date: '2026/4/1',
    event: 'フラッグシップバトル優勝',
    eventType: 'flagship',
    tier: 1,
    colors: ['紫'],
    description: 'cardrush.media 4/1フラッグシップ優勝の最新構成。ST10-011×2でアクセスを高め、OP15-074×2のエネル5コストを追加。OP15-067を2枚に抑えて安定感を重視した型。サンジ型と比べてドン加速をより重視した構成。',
    deck: [
      { cardNumber: 'OP15-061',   count: 4 },
      { cardNumber: 'OP15-066',   count: 4 },
      { cardNumber: 'OP15-067',   count: 2 },
      { cardNumber: 'OP15-071',   count: 4 },
      { cardNumber: 'OP15-060',   count: 4 },
      { cardNumber: 'OP15-118',   count: 4 },
      { cardNumber: 'OP12-071',   count: 4 },
      { cardNumber: 'ST10-011',   count: 2 },
      { cardNumber: 'OP07-064',   count: 3 },
      { cardNumber: 'OP15-077',   count: 4 },
      { cardNumber: 'OP15-075',   count: 4 },
      { cardNumber: 'OP15-076',   count: 3 },
      { cardNumber: 'OP15-078',   count: 4 },
      { cardNumber: 'OP15-074',   count: 2 },
      { cardNumber: 'OP05-077',   count: 2 },
    ],
  },
];
